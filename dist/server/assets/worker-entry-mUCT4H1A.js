...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Or3mS1qo.js");
...
const manifest = {
  "fbd394cc9fa4af3080fc71bce795b650ae4ce5bc0cb7fdb09c73ce183438bcb8": {
    ...
    importer: () => import("./contact.functions-COxpk_CB.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-OM1IP7yR.js").then((n2) => n2.r),
    import("./start-C2rQm8Jy.js"),
