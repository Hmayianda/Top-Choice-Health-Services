...
import { Heart, Pill, Brain, Activity, UtensilsCrossed, Shield, Users, RefreshCw, CheckCircle2 } from "lucide-react";
...
function Services() {
  return /* @__PURE__ */ jsxs(PageWrapper, { children: [
    /* @__PURE__ */ jsx(PageHero, { eyebrow: "What We Offer", title: "Comprehensive Care for Every Need", subtitle: "Personalized services designed around each resident's comfort and wellbeing." }),
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsx(FadeUp, { className: "text-center", children: /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl text-navy-deep sm:text-5xl", children: "Our Services" }) }),
      /* @__PURE__ */ jsx("div", { className: "mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4", children: services.map((s, i) => /* @__PURE__ */ jsx(FadeUp, { delay: i * 0.05, children: /* @__PURE__ */ jsx(ServiceCard, { ...s }) }, s.title)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-light-gray py-20 sm:py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-center", children: [
      /* @__PURE__ */ jsxs(FadeUp, { children: [
        /* @__PURE__ */ jsx("p", { className: "mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold", children: "How We Care" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl text-navy-deep sm:text-5xl", children: "Our Approach to Care" }),
        /* @__PURE__ */ jsx("p", { className: "mt-6 text-lg text-muted-foreground", children: "Every resident at Top Choice Health Services receives a fully individualized care plan developed in collaboration with their family and healthcare providers. We regularly review and update these plans to adapt to changing needs." })
      ] }),
      /* @__PURE__ */ jsx(FadeUp, { delay: 0.2, children: /* @__PURE__ */ jsx("ul", { className: "space-y-4 rounded-2xl bg-white p-8 shadow-md", children: approach.map((step, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsx("span", { className: "grid h-8 w-8 shrink-0 place-items-center rounded-full bg-gold-soft text-sm font-bold text-gold", children: i + 1 }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { size: 18, className: "text-gold" }),
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-navy-deep", children: step })
        ] })
      ] }, step)) }) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-6", children: [
      ...
      /* @__PURE__ */ jsx(FadeUp, { delay: 0.1, className: "mt-12", children: /* @__PURE__ */ jsxs(Accordion, { type: "single", collapsible: true, className: "space-y-4", children: [
        /* @__PURE__ */ jsxs(AccordionItem, { value: "faq-1", className: "rounded-xl border border-border bg-light-gray px-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs(AccordionItem, { value: "faq-2", className: "rounded-xl border border-border bg-light-gray px-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs(AccordionItem, { value: "faq-3", className: "rounded-xl border border-border bg-light-gray px-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs(AccordionItem, { value: "faq-4", className: "rounded-xl border border-border bg-light-gray px-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs(AccordionItem, { value: "faq-5", className: "rounded-xl border border-border bg-light-gray px-6 shadow-sm", children: [
