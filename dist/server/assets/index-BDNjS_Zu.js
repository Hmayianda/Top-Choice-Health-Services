import { V as jsxRuntimeExports, r as reactExports } from "./worker-entry-C79rbQzc.js";
import { L as Link } from "./router-v-SYg5Kn.js";
import { c as createLucideIcon, P as PageWrapper, F as FadeUp } from "./FadeUp-11HYL85t.js";
import { P as Pill, B as Brain, S as ServiceCard, A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-C6nothWg.js";
import { a as ChevronDown, C as CircleCheck } from "./circle-check-BV3A9mab.js";
import { H as Heart, S as Shield } from "./shield-B6lajJeG.js";
import { S as ShieldCheck } from "./shield-check-CBBezJAi.js";
import { A as Award } from "./award-DKZ4NO5U.js";
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageWrapper, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-navy-deep via-navy to-healthcare-blue text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: void 0, alt: "Caregiver assisting senior resident in a warm home environment", className: "absolute inset-0 h-full w-full object-cover opacity-0" }),
