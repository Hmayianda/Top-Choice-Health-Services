import { O as useRouter, r as reactExports, V as jsxRuntimeExports } from "./worker-entry-mUCT4H1A.js";
import { L as Link } from "./router-OM1IP7yR.js";
import { a as SERVICES, S as SITE } from "./site-D-SU5DUN.js";
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", "aria-label": "Top Choice Health Services home", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-semibold text-white", children: "Top Choice" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-gold", children: "Health Services" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden items-center gap-8 lg:flex", children: links.map((l) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  l.label,
                  active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-2 left-0 h-0.5 w-full rounded bg-gold" })
                ]
              }
            ) }, l.to);
          }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 px-6 py-4", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-navy text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 font-display text-lg italic text-gold", children: "Quality Care at Our Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-white/75", children: "A licensed Adult Family Home in Port Orchard, WA providing compassionate, personalized care in a warm family setting." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider text-gold", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: [
          ...
          { to: "/our-home", label: "Our Home" },
          { to: "/contact", label: "Contact" }
        ].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "text-white/80 transition-colors hover:text-gold", children: l.label }) }, l.to)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider text-gold", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: SERVICES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "text-white/80 transition-colors hover:text-gold", children: s }) }, s)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider text-gold", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-white/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, className: "mt-1 shrink-0 text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: SITE.address })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, className: "mt-1 shrink-0 text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: SITE.phoneHref, className: "hover:text-gold", children: SITE.phone })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 16, className: "mt-1 shrink-0 text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${SITE.email}`, className: "hover:text-gold", children: SITE.email })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 border-t border-gold/40 pt-6 text-center text-xs text-white/60", children: "© 2026 Top Choice Health Services LLC. All Rights Reserved." })
  ] }) });
}
function CTABanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-navy-deep text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6 py-16 text-center sm:py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl", children: "Ready to Learn More?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-3 max-w-2xl text-lg text-white/80", children: "We'd love to welcome your family." }),
...
function PageWrapper({ children, showCTA = true }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col bg-background", children: [
    ...
    showCTA && /* @__PURE__ */ jsxRuntimeExports.jsx(CTABanner, {}),
...
function FadeUp({ children, delay: delay2 = 0, ...rest }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      transition: { duration: 0.4, ease: "easeOut", delay: delay2 },
      ...rest,
      children
    }
  );
