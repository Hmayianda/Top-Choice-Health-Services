...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-WYamjz5Y.js");
...
const manifest = {
  "fbd394cc9fa4af3080fc71bce795b650ae4ce5bc0cb7fdb09c73ce183438bcb8": {
    ...
    importer: () => import("./contact.functions-CDPyBFcF.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-v-SYg5Kn.js").then((n2) => n2.r),
    import("./start-BaBG4plm.js"),
