...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CwiOzjBs.js");
...
const manifest = {
  "fbd394cc9fa4af3080fc71bce795b650ae4ce5bc0cb7fdb09c73ce183438bcb8": {
    ...
    importer: () => import("./contact.functions-XyBQfwsQ.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BpjsfuxZ.js").then((n2) => n2.r),
    import("./start-CWt3c8b2.js"),
