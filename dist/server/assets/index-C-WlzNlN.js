import { V as jsxRuntimeExports, r as reactExports } from "./worker-entry-mUCT4H1A.js";
import { L as Link } from "./router-OM1IP7yR.js";
import { c as createLucideIcon, P as PageWrapper, F as FadeUp } from "./FadeUp-BAjr0ynT.js";
import { P as Pill, B as Brain, S as ServiceCard, A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-D3sFzMfo.js";
import { a as ChevronDown, C as CircleCheck } from "./circle-check-DoxgKTvN.js";
import { H as Heart, S as Shield } from "./shield-DT6T3cNd.js";
import { S as ShieldCheck } from "./shield-check-BmKz9itx.js";
import { A as Award } from "./award-DBLHOt8U.js";
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageWrapper, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-navy-deep via-navy to-healthcare-blue text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/src/assets/hero-bg.jpg", alt: "Caregiver assisting senior resident in a warm home environment", className: "absolute inset-0 h-full w-full object-cover opacity-100" }),
