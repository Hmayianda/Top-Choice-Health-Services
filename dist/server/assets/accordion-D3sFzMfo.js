import { c as createLucideIcon } from "./FadeUp-BAjr0ynT.js";
import { V as jsxRuntimeExports, r as reactExports, a6 as React } from "./worker-entry-mUCT4H1A.js";
import "./router-OM1IP7yR.js";
import { a as ChevronDown } from "./circle-check-DoxgKTvN.js";
const __iconNode$1 = [
...
function ServiceCard({ icon: Icon, title, description }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group relative flex h-full flex-col rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-x-6 top-0 h-1 rounded-b-full bg-gold opacity-0 transition-opacity group-hover:opacity-100" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 grid h-12 w-12 place-items-center rounded-xl bg-gold-soft text-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 24, strokeWidth: 2.25 }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-navy-deep", children: title }),
